...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'prototype1.contrib.sites.migrations'
}
...
ACCOUNT_ADAPTER = 'prototype1.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'prototype1.users.adapters.SocialAccountAdapter'
